...
\include{sections/folkratt_section/folkratt_main} % Genomgång av Sveriges folkrättsliga åtaganden och konventionsbundenhet

\include{sections/regeringens_agerande_section/regeringens_agerande_main} % Beskrivning av regeringens faktiska agerande eller passivitet
...
\include{sections/hamas_section/hamas_main} % Analys av regeringens fokus på Hamas och kritik mot snedvriden ansvarsfördelning

\include{sections/atgarder_section/atgarder_main} % Förslag på rättsliga, politiska och diplomatiska åtgärder Sverige borde vidta
